        ...
        <section class="bg-white p-8 rounded-xl max-w-md mx-auto border border-slate-300">
            ...
            <form @submit.prevent="submit">
                <div class="mb-6">
                    ...
                    <input v-model="form.email" class="border p-2 w-full rounded border-slate-300" type="email" name="email"
                        id="email" required>
                ...
                <div class="mb-6">
                    ...
                    <input v-model="form.password" class="border p-2 w-full rounded border-slate-300" type="password"
