...
<template>
    ...
    <p class="grid place-items-center mt-6">
        ...
        <br><br>
        What did I learn? PHP! Inertia! The Vue framework! Server and client side programing! Databases! Web app development! By following along with the tutorial and constructing this website myself, I've been able to see this new language of code in action and understand it more. Even the JavaScript used in this series was entirely new to me. Now, do I completely understand every bit of code that I've written? Not at all. Much of it is still confusing to me, but I'm learning from it nonetheless.
        <br><br>
    ...
    <!--Regular viewing-->
    <p>
        You will notice that on the users page, there is an edit button on some, but not all, of the users. If I had more time to develop the site, the edit button would not be placed randomly with each page refresh. There would be different levels of authorization, and only specific users would be able to edit other users, provided the other users have a lower level of authorization. Also, the edit button currently does nothing.
    </p>
</template>
